...
class Payment(models.Model):
    ...
    def __str__(self):
        """
        Returns a human-readable string representation of the Payment object.
        """
        return f"Payment {self.payment_id.hex[:8]} for Booking {self.booking.booking_id.hex[:8]} - {self.status}"